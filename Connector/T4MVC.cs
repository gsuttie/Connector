...
{
    public static Connector.Controllers.AccountController Account = new Connector.Controllers.T4MVC_AccountController();
    public static Connector.Controllers.HomeController Home = new Connector.Controllers.T4MVC_HomeController();
    public static Connector.Controllers.IdeasController Ideas = new Connector.Controllers.T4MVC_IdeasController();
    public static Connector.Controllers.RavenController Raven = new Connector.Controllers.T4MVC_RavenController();
    public static Connector.Controllers.TagsController Tags = new Connector.Controllers.T4MVC_TagsController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string ajax_util_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ajax-util.min.js") ? Url("ajax-util.min.js") : Url("ajax-util.js");
                      
        public static readonly string bp_index_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/bp-index.min.js") ? Url("bp-index.min.js") : Url("bp-index.js");
        ...
        public static readonly string ko_execute_on_enter_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ko-execute-on-enter.min.js") ? Url("ko-execute-on-enter.min.js") : Url("ko-execute-on-enter.js");
                      
        public static readonly string ko_protected_observable_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ko-protected-observable.min.js") ? Url("ko-protected-observable.min.js") : Url("ko-protected-observable.js");
